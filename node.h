#ifndef node_H
#define node_H
struct song_node{char artist[100]; char title[100]; struct song_node *next; int file;};
int compare(struct song_node * a, struct song_node * b);
struct song_node * insert_song_node(char* artist, char* title, struct song_node *next, int file);
